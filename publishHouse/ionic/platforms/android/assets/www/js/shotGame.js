...
var util = {
  ...
  isEffect: function isEffect(plain, action, eventInfo) {
    var pos = {
  ...
  sceneYTransform: function sceneYTransform(y, option, headOffset) {
...
var _EObject2 = __webpack_require__(4);
...
var _shot = __webpack_require__(19);
...
var _BaseButton2 = __webpack_require__(14);
...
var _BaseModal2 = __webpack_require__(15);
...
var MessageBox = function (_BaseModal) {
  ...
  _createClass(MessageBox, [{
    ...
    value: function render(draw) {
      var me = this;
      _get(MessageBox.prototype.__proto__ || Object.getPrototypeOf(MessageBox.prototype), 'render', this).call(this, draw);
    }
  }]);
...
var _Bullet = __webpack_require__(42);
...
var _ShotTypes = __webpack_require__(44);
...
function ShotorFactory() {
  ...
  var gzShot = function gzShot(ePlayer) {
    ...
    shot.Hp = 100000000;
    shot.width = 100;
    shot.height = _context2.default.viewManager.view.height;
    ...
    // 1.5秒后消失
    setTimeout(function () {
      shot.position.y = _context2.default.viewManager.view.height;
      shot.isDie = true;
      clearTimeout(tm);
    }, 1500);
    return [shot];
...
var _GameCore2 = __webpack_require__(23);

var _GameCore3 = _interopRequireDefault(_GameCore2);

var _spoil = __webpack_require__(48);
...
var ShotGame = function (_GameCore) {
  _inherits(ShotGame, _GameCore);
  ...
  function ShotGame(option) {
    ...
    _context2.default.spoilManager = new _spoil.SpoilManager();
    _context2.default.viewManager.viewProvider.register("view", function (args) {
      return new _View2.default(args);
    });
    _context2.default.viewManager.init();
    return _this;
  }
...
var GameCore = function () {
  ...
  _createClass(GameCore, [{
    ...
    value: function create(_option) {
      ...
      // view
      _context2.default.viewManager = new _ViewManager2.default();
    }
  }, {
    key: 'Start',
    value: function Start() {
      ...
      var before = function before(callback) {
        return function () {
          if (_context2.default.viewManager.view.isRunning == 1) callback();
        };
      };
      ...
      this.checkTm = setInterval(before(function () {
        _context2.default.viewManager.view.checkCollection();
      }), 50);

      this.moveTm = setInterval(before(function () {
        _context2.default.viewManager.view.objectMove();
      }), 50);

      this.clearTm = setInterval(before(function () {
        _context2.default.viewManager.view.clearObject();
      }), 5000);
    }
  }, {
    key: 'draw',
    value: function draw() {
      ...
      _context2.default.UiObjectManager.forEach(function (item) {
        item.render(_this2.drawContext);
      });
    }
  }, {
    key: 'destory',
    value: function destory() {
      _context2.default.viewManager.view.destroy();
...
var _EventWell = __webpack_require__(27);
...
var LosEvent = function () {
  function LosEvent(_option) {
    ...
    this.init(_option);
    this.focusTarget;
    this.clickWell = new _EventWell2.default(2);
    this.keyWell = new _EventWell2.default(3);
  ...
  _createClass(LosEvent, [{
    ...
    value: function triggerNamedEvent(action, eventInfo) {
      ...
      targets.forEach(function (targetItem) {
        _this.invokeEventListiner(targetItem.target, action, eventInfo);
      });
    }
  }, {
    key: 'triggerKeyEvent',
    ...
    value: function moveFunc() {
      ...
      return function (eventInfo) {
        _this3.triggerEvent('mouseMove', _this3.pacakgeEvent(eventInfo));
      };
    }
    // 按下事件
    ...
    value: function moveDownFunc() {
      ...
      return function (eventInfo) {
        _this4.triggerEvent('mouseDown', _this4.pacakgeEvent(eventInfo));
      };
    }
    // 抬起事件
    ...
    value: function moveUpFunc() {
      ...
      return function (eventInfo) {
        _this5.triggerEvent('mouseUp', _this5.pacakgeEvent(eventInfo));
      };
    }
    // 点击事件
    ...
    value: function clickFunc() {
      ...
      return function (eventInfo) {
        _this6.triggerEvent('click', _this6.pacakgeClick(eventInfo));
      };
    }
    // 点击事件
...
var _ViewProvider = __webpack_require__(26);
...
var ViewManager = function () {
  function ViewManager(option) {
    _classCallCheck(this, ViewManager);

    this.viewProvider = new _ViewProvider2.default();
    this.viewsConfig = [{
  ...
  _createClass(ViewManager, [{
    key: 'isViewTimeOut',
    value: function isViewTimeOut() {
      return this.view.isViewTimeOut();
    }
  }, {
    key: 'canGoNextView',
    value: function canGoNextView() {
    ...
    value: function init() {
      ...
      _context2.default.UiObjectManager.removeView(this.view);
...
var ViewProvider = function () {
    ...
    _createClass(ViewProvider, [{
        key: "register",
        value: function register(name, viewCreaator) {
  ...
  _createClass(EventWell, [{
    ...
    value: function triggerComplexEvent() {
      ...
      for (var i = 1; i < this.eventWell.length; i++) {
        ...
        _context2.default.losEvent.triggerNamedEvent(action, eventItem.eventInfo);
      }
    }
  }]);
...
var Bar = function (_Control) {
  ...
  _createClass(Bar, [{
    ...
    value: function render(drawContext) {
      ...
      // hp
      for (var index = 0; index < _context2.default.viewManager.view.player.Hp; index++) {
...
var BaseView = function (_Control) {
    _inherits(BaseView, _Control);

    function BaseView(option) {
        _classCallCheck(this, BaseView);

        var _this = _possibleConstructorReturn(this, (BaseView.__proto__ || Object.getPrototypeOf(BaseView)).call(this, option));
...
var _MessageBox = __webpack_require__(17);
...
var Modal = function (_BaseModal) {
  ...
  function Modal(option) {
    ...
    grid.AddCellContent(new _Button2.default({
      ...
      event: {
        click: function click(obj, eventInfo) {
          var box = new _MessageBox2.default({
            title: '设置页面',
            position: {
              x: 20,
              y: _context2.default.option.ctxHeight / 3
            },
            width: _context2.default.option.ctxWidth - 40,
            height: _context2.default.option.ctxHeight / 3,
            zIndex: 3,
            cancel: 2,
...
var _NumberInput = __webpack_require__(33);
...
var _BasePlain2 = __webpack_require__(6);
...
var Player = function (_BasePlain) {
  ...
  function Player(view) {
    ...
    _this.position.x = (_this.view.width - _this.width) / 2;
    _this.position.y = _this.view.height - _this.height;
    _this.collisionArea = [{
      x: 0,
      y: 0,
      width: _this.width,
...
var _EObject = __webpack_require__(4);

var _EObject2 = _interopRequireDefault(_EObject);

var _BaseView2 = __webpack_require__(30);
...
var View = function (_BaseView) {
  ...
  function View(viewConfig) {
    ...
    var _this = _possibleConstructorReturn(this, (View.__proto__ || Object.getPrototypeOf(View)).call(this, viewConfig));
    ...
    _this.bar = new _ui.Bar({
      ...
      width: _context2.default.option.ctxWidth + 10,
      ...
      children: [new _ui.Button({
        ...
        event: {
          'click': function click(eventInfo) {
            _context2.default.viewManager.view.stop();
            var modal = new _ui.Modal({
              ...
              zIndex: 2,
              confirm: function confirm() {
                _context2.default.viewManager.view.restart();
              },
    ...
    _context2.default.UiObjectManager.addView(_this.resetButton);
    _context2.default.UiObjectManager.addView(_this.bar);
    _context2.default.UiObjectManager.addView(_this.textBlock);
  ...
  _createClass(View, [{
    ...
    value: function objectMove() {
      ...
      if (_context2.default.viewManager.canGoNextView()) {
        _context2.default.viewManager.next();
      }
      // 生成新的个体
    ...
    value: function clearObject() {
      ...
      for (var i = shots.length - 1; i > -1; i--) {
        var oneShot = shots[i];
        if (oneShot.isDie || !_util2.default.inArea(oneShot.position, {
          x: -10,
          y: -10,
          width: this.width + 10,
      ...
      for (var i = enemies.length - 1; i > -1; i--) {
        ...
        if (!_util2.default.inArea(enemy.position, {
          x: -100,
          y: -100,
    ...
    value: function update() {
      ...
      if (Math.random() < 0.07) // 百分之七生成敌军
        {
          ...
          var newEmeny = (0, _index.createEnemy)(parseInt(rad.charAt(0)) + 2);
      ...
      if (Math.random() < 0.01) // 百分之一生成强力敌军
        {
          var newEmeny = (0, _index.createEnemy)(1);
          if (_context2.default.stateInfo.enemies.all[newEmeny.type]) _context2.default.stateInfo.enemies.all[newEmeny.type]++;else _context2.default.stateInfo.enemies.all[newEmeny.type] = 1;
          enemies.push(newEmeny);
        }
...
var _BasePlain = __webpack_require__(6);

var _BasePlain2 = _interopRequireDefault(_BasePlain);

var _Boss = __webpack_require__(37);

var _Boss2 = _interopRequireDefault(_Boss);

var _Enemy = __webpack_require__(38);
...
var createEnemy = function createEnemy(type) {
  ...
  if (type == 1) {
    ...
    enemy.position.x = _context2.default.viewManager.view.width * Math.random();
...
var _Spoil2 = __webpack_require__(7);

var _Spoil3 = _interopRequireDefault(_Spoil2);

var _SpoilType = __webpack_require__(8);
...
var _GzShotSpoil = __webpack_require__(45);

var _GzShotSpoil2 = _interopRequireDefault(_GzShotSpoil);

var _HpSpoil = __webpack_require__(46);

var _HpSpoil2 = _interopRequireDefault(_HpSpoil);

var _Spoil = __webpack_require__(7);
...
var _UmShotSpoil = __webpack_require__(47);
...
window.ShotGame=module.exports;